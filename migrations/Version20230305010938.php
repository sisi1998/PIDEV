 ...
 */
final class Version20230305010938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours ADD arenna_id INT NOT NULL, ADD equipex_id INT NOT NULL, ADD arennnnna_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours DROP arenna_id, DROP equipex_id, DROP arennnnna_id');
